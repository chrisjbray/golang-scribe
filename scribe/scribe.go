...
import(
	...
	"github.com/chrisjbray/golang-scribe/fb303"
...
type Scribe interface {
  ...
  // Parameters:
  //  - Messages
  Log(ctx context.Context, messages []*LogEntry) (_r ResultCode, _err error)
}
...
// Parameters:
//  - Messages
func (p *ScribeClient) Log(ctx context.Context, messages []*LogEntry) (_r ResultCode, _err error) {
  var _args0 ScribeLogArgs
  _args0.Messages = messages
  var _result2 ScribeLogResult
  var _meta1 thrift.ResponseMeta
  _meta1, _err = p.Client_().Call(ctx, "Log", &_args0, &_result2)
...
func NewScribeProcessor(handler Scribe) *ScribeProcessor {
  self3 := &ScribeProcessor{fb303.NewFacebookServiceProcessor(handler)}
  self3.AddToProcessorMap("Log", &scribeProcessorLog{handler:handler})
  return self3
}
...
func (p *scribeProcessorLog) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if err2 = args.Read(ctx, iprot); err2 != nil {
    ...
    oprot.WriteMessageBegin(ctx, "Log", thrift.EXCEPTION, seqId)
    x.Write(ctx, oprot)
  ...
  tickerCancel()
  if err2 = oprot.WriteMessageBegin(ctx, "Log", thrift.REPLY, seqId); err2 != nil {
...
func (p *ScribeLogArgs)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ScribeLogArgs) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *ScribeLogResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ScribeLogResult) writeField0(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
